 ...
 */
public class PropertyDistanceDescComparator implements Comparator<Property> {
    @Override
    public int compare(Property lhs, Property rhs) {
        ...
        return Float.compare(lhLocation.distanceTo(location), rhLocation.distanceTo(location));
    }
